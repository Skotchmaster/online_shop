...
8. [API (через gateway)](#api-через-gateway)
9. [Безопасность](#безопасность)
10. [Производительность](#Производительность)
11. [TODO (план на будущее)](#todo-план-на-будущее)
...
На текущем этапе тесты реализованы только для сервиса `auth`:

- unit: `services/auth/internal/service/auth_test.go`;
- integration: `services/auth/internal/integration/auth_test.go`.
...
Если `AUTH_TEST_DATABASE_URL` не задан, integration-тесты будут пропущены (`SKIP`).
